...
_INJECTION_PATTERNS: List[Tuple[str, re.Pattern]] = [
    ...
    (
        "exfiltrate_secrets",
        re.compile(r"\b(api key|password|secret|token)\b.*\b(show|reveal|dump|exfiltrate|leak)\b", re.I),
    ),
    ...
    (
        ...
        re.compile(r"\b(confidential)\b.*\b(info|information|data)\b.*\b(comply|follow|provide)\b", re.I),
    ),
]
